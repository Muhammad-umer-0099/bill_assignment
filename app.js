function getUnit() {
  ...
  function clearNow(){
    ...
    var newunits = document.getElementById("total")
    var oneHund = document.getElementById("oneHund")
    var oneHundUnit = document.getElementById("oneHundUnit")
    var twoHund = document.getElementById("twoHund")
    var twoHundUnit = document.getElementById("twoHundUnit")
    var threeHund = document.getElementById("threeHund")
    var threeHundUnit = document.getElementById("threeHundUnit")
    var forthHund = document.getElementById("forthHund")
    var forthHundUnit = document.getElementById("forthHundUnit")
    var fifthHund = document.getElementById("fifthHund")
    var fifthHundUnit = document.getElementById("fifthHundUnit")
